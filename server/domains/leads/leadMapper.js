...
export function normalizeLead(lead = {}) {
  ...
  return {
    ...
    sdrResponsible: String(lead.sdrResponsible || lead.sdr_responsible || ""),
    sdrResponsibleUserId: String(lead.sdrResponsibleUserId || lead.sdr_responsible_user_id || ""),
...
export function buildLeadSearchText(lead = {}) {
  ...
  const rawText = [
    ...
    normalizedLead.sdrResponsible,
    normalizedLead.sdrResponsibleUserId,
...
function rowToLeadInput(row = {}) {
  return {
    ...
    sdrResponsible: row.sdr_responsible || "",
    sdrResponsibleUserId: row.sdr_responsible_user_id || "",
