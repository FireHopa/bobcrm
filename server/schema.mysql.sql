...
CREATE TABLE IF NOT EXISTS leads (
  ...
  sdr_responsible VARCHAR(255) NOT NULL DEFAULT '',
  sdr_responsible_user_id VARCHAR(64) NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS whatsapp_accounts (
  ...
  lead_pipeline_id VARCHAR(64) NOT NULL DEFAULT '',
  lead_pipeline_stage_id VARCHAR(64) NOT NULL DEFAULT '',
